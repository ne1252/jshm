...
let users = [
    ...
    new User(3,`marik`,`kokos`,`asd@gmailasd`,123123),
    new User(5,`denus`,`kokos`,`asd@gmailasd`,123124),
    new User(2,`olya`,`kokos`,`asd@gmailasd`,123125),
    new User(4,`Anna`,`kokos`,`asd@gmailasd`,123126),
